...
def ayar_penceresini_ac(parent, db=None, on_save=None):
    ...
    PRESETLER = {
        ...
        "arb":      {"etiket": "🩸 ARB (yalnız)",
                     "buton":  "ARB KONTROL (M.51)",
                     "kapsam": "C09C* / C09D* / C02AC*",
                     "atc":    ["C09C", "C09D", "C02AC"]},
        "antiht_tum": {"etiket": "🫀 Antihipertansif TÜMÜ "
                                  "(ARB + ACE + KKB + BB + Diüretik)",
                       "buton":  "TÜM ANTİHT KONTROL",
                       "kapsam": "C09A/B/C/D + C03 + C07 + C08 + C02AC",
